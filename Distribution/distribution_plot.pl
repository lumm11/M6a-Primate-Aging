...
my $intersectBed="/software/biosoft/software/BEDTools-Version-2.16.2/bin/intersectBed";
my $peak_file="./peak.bed";
my $r="./ratio_position_Macaque";
my $intron="./my/intron-num";
my $utr5="./my/utr5-num";
my $utr3="./my/utr3-num";
my $cds="./my/cds-num";
my $plot="./my/peak-inter-for-plot";
my $fate=2;
my $LYL=1;
my $label;
